...
CREATE TABLE `users` (
  ...
  `perm_view` varchar(150) DEFAULT '1,2,3' COMMENT 'CSV list of project IDs that user can view entries',
  `perm_add` varchar(150) DEFAULT '2' COMMENT 'CSV list of project IDs that user can add entries',
